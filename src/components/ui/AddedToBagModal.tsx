  ...
  return (
    <>
      ...
      <div className={`fixed right-0 z-50 w-full lg:w-auto flex justify-center lg:justify-end ${getTopPosition()}`}>
        <div
          className={`relative bg-white w-full h-auto lg:w-md shadow-2xl transform origin-top transition-all duration-300 ${
        ...
        >
          ...
          <div className="flex flex-col h-full lg:h-auto px-6 pb-8 pt-12">
            {isMaxQuantityExceeded ? (
              ...
              <>
                <h2 className="text-xl font-bold text-center mb-6 font-title">
                  {t('maxQuantityTitle')}
                </h2>
                ...
                {productImage && productName && (
                  <div className="flex gap-4 mb-4">
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      <div>
                        <h3 className="text-lg font-bold font-title">{productName}</h3>
